            ...
            <main>
                ...
                <div class=\"caracteristique\">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type=\"text\", value=\"".$j['Prenom']."\">
                            </td>
                        </tr>
                    </table>
                </div>
                <div class=\"pitiCarte\">
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type=\"text\", value=\"".$j['Numero']."\">
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class=\"pitiCarte\">
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type='date', value='".$j['DateNaissance']."'>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class='pitiCarte'>
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type='text', value='".$j['Taille'])."cm'>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class='pitiCarte'>
                    <table>
                        ...
                        <tr>
                            <td>
                                <input type='text', value='".$j['Poid']."cm'>
                            </td>
                        </tr>
                    </table>
                </div>
